...
LibMikMod.audioBufferPtr=0,LibMikMod.audioBufferUsedLength=0)}static getString(b){if(LibMikMod.cLib&&b){const f=LibMikMod.cLib.HEAP8;let g=0;for(var d=b;f[d]&&1024>g;d++)g++;if(!g)return"";for(d=Array(g);0<g--;)d[g]=f[b+g];return String.fromCharCode.apply(String,d)}return null}static getSongName(){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getSongName()):null}static getModType(){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getModType()):null}static getComment(){return LibMikMod.cLib?
LibMikMod.getString(LibMikMod.cLib._getComment()):null}static getErrno(){return LibMikMod.cLib?LibMikMod.cLib._getErrno():0}static getStrerr(b){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getStrerr(b)):null}static process(b){if(!LibMikMod.cLib)return!1;let d=LibMikMod.audioBufferUsedLength;if(!d){for(var f=0;3>f;f++){d=LibMikMod.cLib._update();if(0>d)return!1;if(d){LibMikMod.audioBufferPtr=LibMikMod.cLib._getAudioBuffer();LibMikMod.audioBufferUsedLength=d;break}}if(!d)return!0}var g=
null;for(f=b.length-1;0<=f;f--){const w=b[f];for(let x=w.length-1;0<=x;x--){const y=w[x];if(!g){var n=y.length<<2;if(d>=n)d=n,g=new Float32Array(LibMikMod.cLib.HEAP8.buffer,LibMikMod.audioBufferPtr,d>>2),LibMikMod.audioBufferPtr+=d,LibMikMod.audioBufferUsedLength-=d;else{LibMikMod.tmpBuffer&&LibMikMod.tmpBuffer.byteLength===n||(LibMikMod.tmpBuffer=new Float32Array(y.length));n=d>>2;g=new Float32Array(LibMikMod.cLib.HEAP8.buffer,LibMikMod.audioBufferPtr,n);LibMikMod.audioBufferPtr=0;d=LibMikMod.audioBufferUsedLength=
...
()=>{this.postResponse({id:this.id,messageId:LibMikModMessageId.INIT})});break;case LibMikModMessageId.CHECK_STATUS:b.id===this.id&&this.postResponse({id:this.id,messageId:LibMikModMessageId.CHECK_STATUS,loading:LibMikMod.loading,loaded:LibMikMod.loaded,loadError:LibMikMod.loadError});break;case LibMikModMessageId.LOAD_MODULE_BUFFER:b.id===this.id&&((b=LibMikMod.loadModule(sampleRate,b.buffer,b.options))?this.postResponse({id:this.id,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,errorCode:b,errorStr:LibMikMod.getStrerr(b)}):
this.postResponse({id:this.id,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,infoSongName:LibMikMod.getSongName(),infoModType:LibMikMod.getModType(),infoComment:LibMikMod.getComment()}));break;case LibMikModMessageId.CHANGE_GENERAL_OPTIONS:LibMikMod.changeGeneralOptions(b.options);break;case LibMikModMessageId.STOP_MODULE:b.id!==this.id||this.ended||(this.ended=!0,LibMikMod.stopModule());break;case LibMikModMessageId.GET_ID:this.postResponse({id:this.id,messageId:LibMikModMessageId.GET_ID})}}process(b,
d,f){return this.id!=LibMikModProcessor.currentId||this.ended?!1:LibMikMod.process(d)?!0:(this.ended||(this.ended=!0,b=LibMikMod.getErrno(),LibMikMod.stopModule(),b?this.postResponse({id:this.id,messageId:LibMikModMessageId.PLAYBACK_ERROR,errorCode:b,errorStr:LibMikMod.getStrerr(b)}):this.postResponse({id:this.id,messageId:LibMikModMessageId.PLAYBACK_ENDED})),!1)}}LibMikModProcessor.currentId=0;registerProcessor("libmikmodprocessor",LibMikModProcessor);
...
function(){return(a._loadModule=a.asm.m).apply(null,arguments)};a._changeGeneralOptions=function(){return(a._changeGeneralOptions=a.asm.n).apply(null,arguments)};a._update=function(){return(a._update=a.asm.o).apply(null,arguments)};a._getErrno=function(){return(a._getErrno=a.asm.p).apply(null,arguments)};a._getStrerr=function(){return(a._getStrerr=a.asm.q).apply(null,arguments)};a._getSongName=function(){return(a._getSongName=a.asm.r).apply(null,arguments)};a._getModType=function(){return(a._getModType=
a.asm.s).apply(null,arguments)};a._getComment=function(){return(a._getComment=a.asm.t).apply(null,arguments)};var E;D=function e(){E||p();E||(D=e)};a.run=p;if(a.preInit)for("function"==typeof a.preInit&&(a.preInit=[a.preInit]);0<a.preInit.length;)a.preInit.pop()();p();return d.ready}}();
