...
null}static getComment(){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getComment(),LibMikMod.cLib._getCommentLength()):null}static process(b){if(!LibMikMod.cLib)return!1;let d=LibMikMod.audioBufferUsedLength;if(!d){for(var f=0;3>f;f++){d=LibMikMod.cLib._update();if(0>d)return!1;if(d){LibMikMod.audioBufferPtr=LibMikMod.cLib._getAudioBuffer();LibMikMod.audioBufferUsedLength=d;break}}if(!d)return!0}var g=null;for(f=b.length-1;0<=f;f--){const w=b[f];for(let x=w.length-1;0<=x;x--){const y=
w[x];if(!g){var n=y.length<<2;if(d>=n)d=n,g=new Float32Array(LibMikMod.cLib.HEAP8.buffer,LibMikMod.audioBufferPtr,d>>2),LibMikMod.audioBufferPtr+=d,LibMikMod.audioBufferUsedLength-=d;else{LibMikMod.tmpBuffer&&LibMikMod.tmpBuffer.byteLength===n||(LibMikMod.tmpBuffer=new Float32Array(y.length));n=d>>2;g=new Float32Array(LibMikMod.cLib.HEAP8.buffer,LibMikMod.audioBufferPtr,n);LibMikMod.audioBufferPtr=0;d=LibMikMod.audioBufferUsedLength=0;LibMikMod.tmpBuffer.set(g);let u=y.length-n;for(;0<u;){if(!d){for(g=
0;3>g;g++){d=LibMikMod.cLib._update();if(0>d){d=0;break}if(d){LibMikMod.audioBufferPtr=LibMikMod.cLib._getAudioBuffer();LibMikMod.audioBufferUsedLength=d;break}}if(!d){LibMikMod.tmpBuffer.fill(0,n);break}}let p=u<<2;p>d&&(p=d);const a=p>>2;g=new Float32Array(LibMikMod.cLib.HEAP8.buffer,LibMikMod.audioBufferPtr,a);LibMikMod.audioBufferPtr+=p;LibMikMod.audioBufferUsedLength-=p;LibMikMod.tmpBuffer.set(g,n);n+=a;u-=a}g=LibMikMod.tmpBuffer}}y.set(g)}}return!0}}LibMikMod.cLib=null;LibMikMod.tmpBuffer=null;
LibMikMod.audioBufferPtr=0;LibMikMod.audioBufferUsedLength=0;LibMikMod.lastReverb=0;LibMikMod.lastHqMixer=1;LibMikMod.lastInterpolation=1;LibMikMod.lastNoiseReduction=1;LibMikMod.lastWrap=0;LibMikMod.lastLoop=0;LibMikMod.lastFadeout=1;LibMikMod.loading=!1;LibMikMod.loaded=!1;LibMikMod.loadError=!1;"use strict";
...
LibMikModProcessor.currentId||this.ended?!1:LibMikMod.process(d)?!0:(this.ended||(this.ended=!0,LibMikMod.stopModule(),this.postResponse({id:this.id,messageId:LibMikModMessageId.PLAYBACK_ENDED})),!1)}}LibMikModProcessor.currentId=0;registerProcessor("libmikmodprocessor",LibMikModProcessor);
