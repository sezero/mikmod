...
var LibMikMod=function(){function a(){}a.isSupported=function(){return"AudioWorklet"in window&&"AudioWorkletNode"in window&&"WebAssembly"in window};a.init=function(b,e){return __awaiter(this,void 0,void 0,function(){var k,f;return __generator(this,function(h){switch(h.label){case 0:if(a.initialized)return[2];e?e.endsWith("/")||(e+="/"):e="";a.initialized=!0;return[4,fetch(e+"libmikmodclib.wasm")];case 1:return k=h.sent(),f=a,[4,k.arrayBuffer()];case 2:return f.wasmBuffer=h.sent(),[2,b.audioWorklet.addModule(e+
"libmikmodprocessor.min.js")]}})})};a.postMessage=function(b){a.audioNode&&(b.buffer?a.audioNode.port.postMessage(b,[b.buffer]):a.audioNode.port.postMessage(b))};a.loadModule=function(b,e,k,f,h,g){if(a.loading)throw Error("Still loading");if(a.loadError)throw Error("Error loading the library");if(!e)throw Error("Null source");b=new AudioWorkletNode(b,"libmikmodprocessor");b.port.onmessage=a.handleResponse;b.onprocessorerror=a.notifyProcessorError;a.audioNode=b;a.infoSongName=null;a.infoModType=null;
a.infoComment=null;a.onload=k;a.onerror=f;a.onended=h;a.loadOptions=g;a.loading=!0;if("lastModified"in e)if("arrayBuffer"in e)e.arrayBuffer().then(a.startLoadingModule,a.notifyReaderError);else{var c=new FileReader;c.onerror=a.notifyReaderError;c.onload=function(){c.result?a.startLoadingModule(c.result):a.notifyReaderError()};c.readAsArrayBuffer(e)}else a.startLoadingModule(e)};a.startLoadingModule=function(b){a.srcBuffer=b;a.postMessage({id:a.currentId,messageId:LibMikModMessageId.GET_ID})};a.finishLoadingModule=
function(){a.loaded?a.srcBuffer?(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,buffer:a.srcBuffer,options:a.loadOptions}),a.srcBuffer=null,a.loadOptions=null):a.notifyError(a.ERROR_MODULE_LOAD,"Null srcBuffer"):a.wasmBuffer?(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.INIT,buffer:a.wasmBuffer}),a.wasmBuffer=null):a.notifyError(a.ERROR_INITIALIZE,"Null wasmBuffer")};a.changeGeneralOptions=function(b){a.postMessage({id:a.currentId,messageId:LibMikModMessageId.CHANGE_GENERAL_OPTIONS,
options:b})};a.stopModule=function(){a.audioNode&&(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.STOP_MODULE}),a.currentId=0,a.audioNode=null,a.srcBuffer=null,a.onload=null,a.onerror=null,a.onended=null)};a.notifyReaderError=function(b){a.notifyError(a.ERROR_FILE_READ,b)};a.notifyProcessorError=function(b){a.notifyError(a.ERROR_PLAYBACK,b)};a.notifyError=function(b,e){if(a.audioNode){a.loading=!1;a.currentId=0;a.audioNode=null;a.srcBuffer=null;var k=a.onerror;a.onload=null;a.onerror=
null;a.onended=null;k&&k(b,e)}};a.notifyEnded=function(){if(a.audioNode){a.currentId=0;a.audioNode=null;a.srcBuffer=null;var b=a.onended;a.onload=null;a.onerror=null;a.onended=null;b&&b()}};a.handleResponse=function(b){if(b=b.data)switch(b.messageId){case LibMikModMessageId.INIT:a.loading&&a.postMessage({id:a.currentId,messageId:LibMikModMessageId.CHECK_STATUS});break;case LibMikModMessageId.CHECK_STATUS:if(b.id!==a.currentId)break;b.loading?setTimeout(function(){a.postMessage({id:a.currentId,messageId:LibMikModMessageId.CHECK_STATUS})},
10):b.loaded?(a.loaded=!0,a.srcBuffer?(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,buffer:a.srcBuffer,options:a.loadOptions}),a.srcBuffer=null,a.loadOptions=null):a.loading=!1):(a.loading=!1,a.loadError=!0,a.notifyError(a.ERROR_INITIALIZE));break;case LibMikModMessageId.LOAD_MODULE_BUFFER:if(b.id!==a.currentId)break;a.loading=!1;a.onload&&a.onerror&&a.audioNode&&(b.result?a.notifyError(a.ERROR_MODULE_LOAD,b.result):(a.infoSongName=b.infoSongName||null,a.infoModType=
b.infoModType||null,a.infoComment=b.infoComment||null,a.onload(a.audioNode)));break;case LibMikModMessageId.PLAYBACK_ERROR:if(b.id!==a.currentId)break;a.notifyProcessorError(b.result);break;case LibMikModMessageId.PLAYBACK_ENDED:if(b.id!==a.currentId)break;a.notifyEnded();break;case LibMikModMessageId.GET_ID:a.currentId=b.id,a.finishLoadingModule()}};a.ERROR_INITIALIZE=1;a.ERROR_FILE_READ=2;a.ERROR_MODULE_LOAD=3;a.ERROR_PLAYBACK=4;a.initialized=!1;a.loading=!1;a.loaded=!1;a.loadError=!1;a.infoSongName=
null;a.infoModType=null;a.infoComment=null;a.currentId=0;a.audioNode=null;a.wasmBuffer=null;a.srcBuffer=null;a.loadOptions=null;a.onload=null;a.onerror=null;a.onended=null;return a}();
