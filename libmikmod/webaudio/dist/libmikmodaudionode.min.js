...
var LibMikModAudioNode=function(){function a(){}a.isSupported=function(){return"AudioWorklet"in window&&"AudioWorkletNode"in window&&"WebAssembly"in window};a.init=function(b,f){return __awaiter(this,void 0,void 0,function(){var k,e;return __generator(this,function(h){switch(h.label){case 0:if(a.initialized)return[2];f?f.endsWith("/")||(f+="/"):f="";a.initialized=!0;return[4,fetch(f+"libmikmodclib.wasm")];case 1:return k=h.sent(),e=a,[4,k.arrayBuffer()];case 2:return e.wasmBuffer=h.sent(),[2,b.audioWorklet.addModule(f+
"libmikmodprocessor.min.js")]}})})};a.postMessage=function(b){a.audioNode&&(b.buffer?a.audioNode.port.postMessage(b,[b.buffer]):a.audioNode.port.postMessage(b))};a.loadModule=function(b,f,k,e,h,g){if(a.loading)throw Error("Still loading");if(a.loadError)throw Error("Error loading the library");if(!f)throw Error("Null buffer");b=new AudioWorkletNode(b,"libmikmodprocessor");b.port.onmessage=a.handleResponse;b.onprocessorerror=a.notifyError;a.audioNode=b;a.infoSongName=null;a.infoModType=null;a.infoComment=
null;a.srcBuffer=f;a.onload=k;a.onerror=e;a.onended=h;a.loadOptions=g;a.loading=!0;a.postMessage({id:a.currentId,messageId:LibMikModMessageId.GET_ID})};a.finishLoadingModule=function(){a.loaded?a.srcBuffer?(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,buffer:a.srcBuffer,options:a.loadOptions}),a.srcBuffer=null,a.loadOptions=null):this.notifyError("Null srcBuffer"):a.wasmBuffer?(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.INIT,buffer:a.wasmBuffer}),a.wasmBuffer=
null):this.notifyError("Null wasmBuffer")};a.changeGeneralOptions=function(b){a.postMessage({id:a.currentId,messageId:LibMikModMessageId.CHANGE_GENERAL_OPTIONS,options:b})};a.stopModule=function(){a.audioNode&&(a.postMessage({id:a.currentId,messageId:LibMikModMessageId.STOP_MODULE}),a.currentId=0,a.audioNode=null,a.srcBuffer=null,a.onload=null,a.onerror=null,a.onended=null)};a.notifyError=function(b){if(a.audioNode){a.currentId=0;a.audioNode=null;a.srcBuffer=null;var f=a.onerror;a.onload=null;a.onerror=
null;a.onended=null;f&&f(b)}};a.notifyEnded=function(){if(a.audioNode){a.currentId=0;a.audioNode=null;a.srcBuffer=null;var b=a.onended;a.onload=null;a.onerror=null;a.onended=null;b&&b()}};a.handleResponse=function(b){if(b=b.data)switch(b.messageId){case LibMikModMessageId.INIT:a.loading&&a.postMessage({id:a.currentId,messageId:LibMikModMessageId.CHECK_STATUS});break;case LibMikModMessageId.CHECK_STATUS:if(b.id!==a.currentId)break;b.loading?setTimeout(function(){a.postMessage({id:a.currentId,messageId:LibMikModMessageId.CHECK_STATUS})},
