...
CALL emcc ^
	...
	-s EXPORTED_FUNCTIONS="['_init', '_freeModule', '_terminate', '_preLoadModule', '_loadModule', '_changeGeneralOptions', '_update', '_getSongName', '_getSongNameLength', '_getModType', '_getModTypeLength', '_getComment', '_getCommentLength', '_getAudioBuffer', '_getAudioBufferMaxLength', '_getAudioBufferUsedLength']" ^
